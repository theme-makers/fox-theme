!function (t, e) {
    ...
    t.breakingNews = function (e, i) {
        ...
        n.settings = {};
        var r = t(e), o = (e = e, r.children(".bn-label")), a = r.children(".bn-news"), l = a.children("ul"),
            c = l.children("li"), d = r.children(".bn-controls"), f = d.find(".bn-prev").parent(),
            h = d.find(".bn-action").parent(), u = d.find(".bn-next").parent(), g = !1, p = !0,
            m = l.children("li").length, b = 0, y = !1, w = function () {
                ...
                t -= n.settings.scrollSpeed / 2, l.css({marginLeft: t}), t <= -l.find("li:first-child").outerWidth() && (l.find("li:first-child").insertAfter(l.find("li:last-child")), l.css({marginLeft: 0})), !1 === g && (window.requestAnimationFrame && requestAnimationFrame(k) || setTimeout(k, 16))
            }, v = function () {
                var t = parseFloat(l.css("marginRight"));
                t -= n.settings.scrollSpeed / 2, l.css({marginRight: t}), t <= -l.find("li:first-child").outerWidth() && (l.find("li:first-child").insertAfter(l.find("li:last-child")), l.css({marginRight: 0})), !1 === g && (window.requestAnimationFrame && requestAnimationFrame(v) || setTimeout(v, 16))
            }, q = function () {
                switch (p = !0, n.settings.effect) {
                    ...
                    case"fade":
                        ...
                        break;
                    case"slide-down":
                        m <= 1 ? l.find("li").animate({top: 30, opacity: 0}, 300, function () {
                            t(this).css({top: -30, opacity: 0, display: "block"}), t(this).animate({
                                top: 0,
                                opacity: 1
                            }, 300)
                        }) : (l.find("li:visible").animate({top: 30, opacity: 0}, 300, function () {
                            t(this).hide()
                        }), l.find("li").eq(b).css({top: -30, opacity: 0}).show(), l.find("li").eq(b).animate({
                            top: 0,
                            opacity: 1
                        }, 300));
                        break;
                    case"slide-up":
                        ...
                        break;
                    case"slide-left":
                        m <= 1 ? l.find("li").animate({left: "50%", opacity: 0}, 300, function () {
                            t(this).css({left: -50, opacity: 0, display: "block"}), t(this).animate({
                                left: 0,
                                opacity: 1
                            }, 300)
                        }) : (l.find("li:visible").animate({left: "50%", opacity: 0}, 300, function () {
                            t(this).hide()
                        }), l.find("li").eq(b).css({left: -50, opacity: 0}).show(), l.find("li").eq(b).animate({
                            left: 0,
                            opacity: 1
                        }, 300));
                        break;
        ...
        n.init = function () {
            if (n.settings = t.extend({}, s, i), "fixed-top" === n.settings.position ? r.addClass("bn-fixed-top").css({"z-index": n.settings.zIndex}) : "fixed-bottom" === n.settings.position && r.addClass("bn-fixed-bottom").css({"z-index": n.settings.zIndex}), "default" != n.settings.fontSize && r.css({"font-size": n.settings.fontSize}), "default" != n.settings.themeColor && (r.css({
                "border-color": n.settings.themeColor,
                color: n.settings.themeColor
            }), o.css({background: n.settings.themeColor})), "default" != n.settings.background && r.css({background: n.settings.background}), r.css({
                height: n.settings.height,
                "line-height": n.settings.height - 2 * n.settings.borderWidth + "px",
                "border-radius": n.settings.radius,
                "border-width": n.settings.borderWidth
            }), c.find(".bn-seperator").css({height: n.settings.height - 2 * n.settings.borderWidth}), r.addClass("bn-effect-" + n.settings.effect + " bn-direction-" + n.settings.direction), w(), "object" == typeof n.settings.source) switch (n.settings.source.type) {
                case"rss":
                    "rss2json" === n.settings.source.usingApi ? ((d = new XMLHttpRequest).onreadystatechange = function () {
                        if (4 == d.readyState && 200 == d.status) {
                            var t = JSON.parse(d.responseText), e = "", i = "";
                            ...
                            l.empty().append(e), c = l.children("li"), m = l.children("li").length, w(), "scroll" != n.settings.effect && q(), c.find(".bn-seperator").css({height: n.settings.height - 2 * n.settings.borderWidth}), x()
                        }
                        ...
                        if (4 == e.readyState) if (200 == e.status) {
                            var t = JSON.parse(e.responseText), i = "", s = "";
                            switch (n.settings.source.showingField) {
                                case"title":
                                    s = "title";
                                    break;
                            ...
                            l.empty().append(i), c = l.children("li"), m = l.children("li").length, w(), "scroll" != n.settings.effect && q(), c.find(".bn-seperator").css({height: n.settings.height - 2 * n.settings.borderWidth}), x()
            ...
            !function () {
                switch (n.settings.effect) {
                    case"scroll":
                        "rtl" === n.settings.direction ? l.stop().animate({marginRight: -l.find("li:first-child").outerWidth()}, 300, function () {
            ...
            !function () {
                switch (n.settings.effect) {
                    case"scroll":
                        "rtl" === n.settings.direction ? (0 <= parseInt(l.css("marginRight"), 10) && (l.css({"margin-right": -l.find("li:last-child").outerWidth()}), l.find("li:last-child").insertBefore(l.find("li:first-child"))), l.stop().animate({marginRight: 0}, 300, function () {
                            p = !0
                        })) : (0 <= parseInt(l.css("marginLeft"), 10) && (l.css({"margin-left": -l.find("li:last-child").outerWidth()}), l.find("li:last-child").insertBefore(l.find("li:first-child"))), l.stop().animate({marginLeft: 0}, 300, function () {
                            p = !0
                        }));
                        break;
                    default:
